  ...
  <body>
    ...
    <!-- Header and text -->
      ...
      <form action="./results.php" method="post" target="results">
        <label for="first number">Enter integer:</label>
        <input type="number" step="1" name="first-number" placeholder="An integer..."><br><br>
        <label for="second number">Enter another integer:</label>
        <input type="number" step="1" name="second-number" placeholder="Another integer..."><br><br>
